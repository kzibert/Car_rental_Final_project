...
/**
 * Servlet for showing all cars
 * Role: admin
 */

@WebServlet("/car_manage")
public class CarManagementServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String address = "car_management.jsp";
        ...
        int size = dbManager.getAllCarsSize();
        ...
        try {
            ...
            cars = dbManager.getAllCars(pageSize * (page - 1), pageSize);
        } catch (DBException e) {
