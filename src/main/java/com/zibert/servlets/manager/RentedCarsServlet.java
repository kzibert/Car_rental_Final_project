...
/**
 * Servlet for showing all active orders
 * Role: manager
 */

@WebServlet("/rented_cars")
public class RentedCarsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String address = "rented_cars.jsp";
        ...
        int size = dbManager.getApprovedOrdersSize();
        ...
        try {
            orders = dbManager.getAllApprovedOrders(pageSize * (page - 1), pageSize);
        } catch (DBException e) {
