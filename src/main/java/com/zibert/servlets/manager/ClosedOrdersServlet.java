...
/**
 * Servlet for showing all closed orders
 * Role: manager
 */

@WebServlet("/closed_orders")
public class ClosedOrdersServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String address = "closed_orders.jsp";
        ...
        int size = dbManager.getClosedOrdersSize();
        ...
        try {
            closedOrders = dbManager.getAllClosedOrders(pageSize * (page - 1), pageSize);
        } catch (DBException e) {
